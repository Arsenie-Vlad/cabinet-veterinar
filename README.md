...
baza de date MySQL;
serverul backend Spring Boot;
aplicația frontend React.
Pasul 1: Configurarea bazei de date
Instalează și pornește XAMPP.
Pornește modulul MySQL.
Intră în phpMyAdmin:
http://localhost/phpmyadmin
Creează o bază de date nouă cu numele:
veterinar_db
Verifică portul MySQL.
